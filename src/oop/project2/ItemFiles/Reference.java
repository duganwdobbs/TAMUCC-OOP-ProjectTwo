 ...
 * @author jeremy
 */
public class Reference extends Item throws ItemNotInStockError, ReferenceCheckoutError{

    /**
     * @var1 Static int to hold the number of variables this class has
     * @var2 Private string name
     * @var3 Private string description
     * @var4 Private int quantity to hold the number of items in stock, or in
     * order
